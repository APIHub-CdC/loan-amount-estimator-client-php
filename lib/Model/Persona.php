...
class Persona implements ModelInterface, ArrayAccess
{
    ...
    protected static $laeModelName = 'Persona';
    ...
    protected static $laeTypes = [
        ...
        'curp' => 'string',
        'nacionalidad' => 'string',
        'residencia' => '\lae\Client\Model\CatalogoResidencia',
        'estado_civil' => '\lae\Client\Model\CatalogoEstadoCivil',
        'sexo' => '\lae\Client\Model\CatalogoSexo',
        'clave_elector_ife' => 'string',
        'numero_dependientes' => 'int',
        'fecha_defuncion' => 'string',
        'domicilio' => '\lae\Client\Model\DomicilioPeticion'
    ];
    ...
    public function setCurp($curp)
    {
        if (!is_null($curp) && (mb_strlen($curp) > 18)) {
            throw new \InvalidArgumentException('invalid length for $curp when calling Persona., must be smaller than or equal to 18.');
        }
