...
class DomicilioPeticion implements ModelInterface, ArrayAccess
{
    ...
    protected static $laeModelName = 'DomicilioPeticion';
    ...
    protected static $laeTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\lae\Client\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\lae\Client\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\lae\Client\Model\CatalogoTipoAsentamiento',
        'pais' => '\lae\Client\Model\CatalogoNacionalidad'
    ];
